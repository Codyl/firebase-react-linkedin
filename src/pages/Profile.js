  ...
  <form className={formClassName} onSubmit={handleSubmit(onSubmit)}>
    <div className="fields">
      <div className="eight wide field">
        <label>
          Name
          <input type="text" name="name" {...register("fieldArray.name")} />
        </label>
      </div>
      <div className="eight wide field">
        <label>
          Email
          <input type="text" name="email" disabled {...register("fieldArray.email")} />
        </label>
      </div>
    </div>
    <div className="fields">
      <div className="six wide field">
        <label>
          Address
          <input type="text" name="address" {...register("fieldArray.address")} />
        </label>
      </div>
      <div className="five wide field">
        <label>
          City
          <input type="text" name="city" {...register("fieldArray.city")} />
        </label>
      </div>
      <div className="two wide field">
        <label>
          State
          <input type="text" name="state" {...register("fieldArray.state")} />
        </label>
      </div>
    ...
    <div className="equal width fields">
      <div className="field">
        <label>
          Phone
          <input type="text" name="phone" {...register("fieldArray.phone")} />
        </label>
      </div>
      <div className="field">
        <label>
          Specialty
          <select className="specialty" name="specialty" {...register("fieldArray.specialty")}>
